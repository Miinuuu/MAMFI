...
parser.add_argument('--path',default='/data/datasets/HD_dataset', type=str, required=False)
...
for data in tqdm(name_list):
    ...
    for index in range(0, 100, 4):
        ...
        pred_list = model.multi_inference(I0, I1, TTA=TTA, time_list=timestep, fast_TTA = TTA)
