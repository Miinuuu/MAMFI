...
parser.add_argument('--path', default='/data/datasets/snufilm',type=str, required=False)
...
for test_file in level_list:
    ...
    for line in tqdm(file_list):
        ...
        I1_pred = model.hr_inference(I0, I2, timestep=timestep,  down_scale=down_scale, TTA=TTA, fast_TTA=TTA)[0]
